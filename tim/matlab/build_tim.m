...
mex timRenyiEntropyLps.cpp @build_options.txt
mex timTemporalRenyiEntropyLps.cpp @build_options.txt

mex timTsallisEntropyLps.cpp @build_options.txt
mex timTemporalTsallisEntropyLps.cpp @build_options.txt
