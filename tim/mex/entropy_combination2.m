% ENTROPY_COMBINATION2
% An entropy combination estimate from samples.
%
% I = entropy_combination2(signalSet, rangeSet, lagSet, k, threads)
%
% where
%
...
function I = entropy_combination2(signalSet, rangeSet, lagSet, k, threads)
...
I = timEntropyCombination2(signalSet, rangeSet, lagSet, k, threads);
